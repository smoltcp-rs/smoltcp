use super::{Device, DeviceCapabilities, PacketMeta};
...
impl<D: Device> Device for FaultInjector<D> {
    ...
    fn receive(&mut self, timestamp: Instant) -> Option<(Self::RxToken<'_>, Self::TxToken<'_>)> {
        ...
        let rx_meta = <D::RxToken<'_> as super::RxToken>::meta(&rx_token);
...
impl<'a> super::RxToken for RxToken<'a> {
...
#[doc(hidden)]
pub struct TxToken<'a, Tx: super::TxToken> {
    state: &'a mut State,
    config: Config,
    token: Tx,
    junk: [u8; MTU],
...
impl<'a, Tx: super::TxToken> super::TxToken for TxToken<'a, Tx> {
