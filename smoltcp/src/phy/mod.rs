...
```rust
use smoltcp::phy::{DeviceCapabilities, Device, Medium, RxToken, TxToken};
...
pub use smolutils::phy::{Checksum, ChecksumCapabilities, Medium};
use smolutils::time::Instant;
...
impl DeviceCapabilities {
    pub fn ip_mtu(&self) -> usize {
        match self.medium {
            ...
            Medium::Ethernet => {
                self.max_transmission_unit - smolwire::EthernetFrame::<&[u8]>::header_len()
            }
