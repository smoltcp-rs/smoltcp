...
#[doc(hidden)]
pub struct RxToken<'a, Rx: super::RxToken, F: Fuzzer + 'a> {
    fuzzer: &'a F,
    token: Rx,
}

impl<'a, Rx: super::RxToken, FRx: Fuzzer> super::RxToken for RxToken<'a, Rx, FRx> {
...
#[doc(hidden)]
pub struct TxToken<'a, Tx: super::TxToken, F: Fuzzer + 'a> {
    fuzzer: &'a F,
    token: Tx,
}

impl<'a, Tx: super::TxToken, FTx: Fuzzer> super::TxToken for TxToken<'a, Tx, FTx> {
