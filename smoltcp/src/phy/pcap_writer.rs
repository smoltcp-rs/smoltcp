...
#[doc(hidden)]
pub struct RxToken<'a, Rx: super::RxToken, S: PcapSink> {
    token: Rx,
    sink: &'a RefCell<S>,
    mode: PcapMode,
    timestamp: Instant,
...
impl<'a, Rx: super::RxToken, S: PcapSink> super::RxToken for RxToken<'a, Rx, S> {
...
#[doc(hidden)]
pub struct TxToken<'a, Tx: super::TxToken, S: PcapSink> {
    token: Tx,
    sink: &'a RefCell<S>,
    mode: PcapMode,
    timestamp: Instant,
...
impl<'a, Tx: super::TxToken, S: PcapSink> super::TxToken for TxToken<'a, Tx, S> {
