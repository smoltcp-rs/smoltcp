...
use smolwire::{DhcpOption, HardwareAddress};
...
const DEFAULT_PARAMETER_REQUEST_LIST: &[u8] = &[
    Dhcpv4Fields::OPT_SUBNET_MASK,
    Dhcpv4Fields::OPT_ROUTER,
    Dhcpv4Fields::OPT_DOMAIN_NAME_SERVER,
];
