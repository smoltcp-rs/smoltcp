...
impl<'a> Socket<'a> {
    ...
    fn seq_to_transmit(&self, cx: &mut Context) -> bool {
        let ip_header_len = match self.tuple.unwrap().local.addr {
            ...
            IpAddress::Ipv4(_) => smolwire::IPV4_HEADER_LEN,
            #[cfg(feature = "proto-ipv6")]
            IpAddress::Ipv6(_) => smolwire::IPV6_HEADER_LEN,
        };
...
mod test {
    ...
    cfg_if::cfg_if! {
        if #[cfg(feature = "proto-ipv4")] {
            use smolwire::Ipv4Address as IpvXAddress;
            use smolwire::Ipv4Repr as IpvXRepr;
            ...
            use smolwire::Ipv6Address as IpvXAddress;
            use smolwire::Ipv6Repr as IpvXRepr;
