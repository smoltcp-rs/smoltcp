...
use smolwire::{IpProtocol, IpRepr, IpVersion};
#[cfg(feature = "proto-ipv4")]
use smolwire::{Ipv4Packet, Ipv4Repr};
#[cfg(feature = "proto-ipv6")]
use smolwire::{Ipv6Packet, Ipv6Repr};
...
mod test {
    ...
    use smolwire::IpRepr;
    #[cfg(feature = "proto-ipv4")]
    use smolwire::{Ipv4Address, Ipv4Repr};
    #[cfg(feature = "proto-ipv6")]
    use smolwire::{Ipv6Address, Ipv6Repr};
