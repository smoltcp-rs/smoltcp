...
use smolwire::IcmpRepr;
#[cfg(feature = "proto-ipv4")]
use smolwire::{Icmpv4Packet, Icmpv4Repr, Ipv4Repr};
#[cfg(feature = "proto-ipv6")]
use smolwire::{Icmpv6Packet, Icmpv6Repr, Ipv6Repr};
use smolwire::{IpAddress, IpListenEndpoint, IpProtocol, IpRepr};
use smolwire::{UdpPacket, UdpRepr};
...
mod test_ipv4 {
    ...
    use smolwire::{Icmpv4DstUnreachable, IpEndpoint, Ipv4Address};
...
mod test_ipv6 {
    ...
    use smolwire::{Icmpv6DstUnreachable, IpEndpoint, Ipv6Address};
