...
use crate::phy::{Device, DeviceCapabilities, PacketMeta, RxToken, TxToken};
use crate::rand::Rand;
use smolutils::phy::{ChecksumCapabilities, Medium};
...
#[cfg(feature = "proto-ipv4")]
use smolwire::Ipv4Packet as Ipv4PacketWire;
#[cfg(feature = "proto-ipv6")]
use smolwire::Ipv6Packet as Ipv6PacketWire;
...
impl InterfaceInner {
    ...
    pub(crate) fn mock() -> Self {
        ...
        // TODO: remove blocks when https://github.com/rust-lang/rust/issues/15701 is fixed.
        #[cfg(feature = "medium-ethernet")]
        {
            caps.medium = crate::phy::Medium::Ethernet;
        }
        #[cfg(all(not(feature = "medium-ethernet"), feature = "medium-ip"))]
        {
            caps.medium = crate::phy::Medium::Ip;
        }
        #[cfg(all(not(feature = "medium-ethernet"), feature = "medium-ieee802154"))]
        {
            caps.medium = crate::phy::Medium::Ieee802154;
        }

        caps.checksum = crate::phy::ChecksumCapabilities::default();
