...
use smolutils::time::Duration;

use super::{Error, Result};
use crate::icmpv6::{field, Message, Packet};
use crate::Ipv6Address;
use crate::RawHardwareAddress;
use crate::{NdiscOption, NdiscOptionRepr};
use crate::{NdiscPrefixInformation, NdiscRedirectedHeader};
...
mod test {
    use super::*;
    use crate::ip::test::{MOCK_IP_ADDR_1, MOCK_IP_ADDR_2};
    use crate::EthernetAddress;
    use crate::Icmpv6Repr;
