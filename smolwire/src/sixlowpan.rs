...
use crate::ieee802154::Address as LlAddress;
use crate::ipv6;
...
pub mod frag {
    ...
    use crate::{Ieee802154Address, Ieee802154Repr};
...
pub mod iphc {
    ...
    use crate::{ieee802154::Address as LlAddress, ipv6, IpProtocol};
    use byteorder::{ByteOrder, NetworkEndian};
...
pub mod nhc {
    ...
    use byteorder::{ByteOrder, NetworkEndian};
    use ipv6::Address;
    use smolutils::phy::ChecksumCapabilities;
    ...
    mod tests {
        ...
        use crate::{Ipv6RoutingHeader, Ipv6RoutingRepr};
...
mod test {
    ...
    fn sixlowpan_three_fragments() {
        use crate::ieee802154::Frame as Ieee802154Frame;
        use crate::ieee802154::Repr as Ieee802154Repr;
        use crate::Ieee802154Address;
