...
//!
//! A Rank can be thought of as a fixed-point number, where the position of teh radix point between
...
// TODO(diana): check if comparison is calculated correctly
...
mod tests {
    ...
    #[test]
    fn comparison() {
        let r1 = Rank::new(27, 16);
        let r2 = Rank::new(26, 16);
